...
export class DakimakuraComponent implements OnInit, OnChanges {
  ...
  drawTable(): void {
    ...
    this.table = new Tabulator(this.tab, {
      ...
      columns: [
        {title:"캐릭터", field:"title", sorter:"string", width:100,  hozAlign:"center", editor:"textarea"},
        {title:"제작", field:"brand", sorter:"string", hozAlign:"center",editor:"textarea"},
        {title:"가격", field:"price", sorter:"string", hozAlign:"center",editor:"number", editorParams:{
          min:0,
          max:1000000,
          step:10,
          }
        ...
        {title:"재질", field:"material", sorter:"number", hozAlign:"center", width: 150, formatter: function(cell, formatterParams,  onRendered){
      ...
      rowClick: function (e, selectedRow) {
        ...
        self.lightboxName = selectedGoods.image;
      },
